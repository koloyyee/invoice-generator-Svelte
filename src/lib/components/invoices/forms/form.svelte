<script lang="ts">
  ...
  import { updateInvoice } from '../../../apis/invoices';
  import type { IItem } from '../../../interfaces/index';
  import { additionalNote } from '../../../stores/invoice';
  ...
  import InvoiceDate from './date.svelte';
  import IssuerInfo from './issuer-info.svelte';
